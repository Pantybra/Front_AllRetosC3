...
function agregarReservation() {
    if (
        ...
        $.ajax({
            ...
            url: "http://129.151.114.113:8080/api/Reservation/save",
...
function listarReservation() {
    $.ajax({
        url: "http://129.151.114.113:8080/api/Reservation/all",
        type: "GET",
        datatype: "JSON",
        success: function (response) {
            console.log(response);
...
function borrarReservation(idElemento) {
    ...
    $.ajax({
        dataType: "json",
        data: dataToSend,
        url: "http://129.151.114.113:8080/api/Reservation/" + idElemento,
        type: "DELETE",
        contentType: "application/JSON",
        success: function (response) {
            console.log(response);
...
function cargarDatosReservation(id) {
    $.ajax({
        dataType: "json",
        url: "http://129.151.114.113:8080/api/Reservation/" + id,
        type: "GET",
...
function actualizarReservation(idElemento) {
    if (
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url: "http://129.151.114.113:8080/api/Reservation/update",
            type: "PUT",
